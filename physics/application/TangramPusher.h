...
class TangramPusher : public MinimalVisualizer {
  private:
  ...
  public:
    TangramPusher():m_shouldApplyForce(0),dx(0),dz(0) {/* initPhysics(); initScene();*/ }
    virtual ~TangramPusher() { freeScene(); freePhysics(); }
